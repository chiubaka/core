...
function mapDispatchToProps(dispatch) {
    return {
        ...
        onOAuth2Completion: (provider, code, oAuth2CallbackUri) => {
            dispatch(actions_1.AuthApi.getInstance().socialLogin(provider, code, oAuth2CallbackUri));
        },
    };
}
exports.default = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(react_router_dom_1.withRouter(OAuth2CompletionPage));
